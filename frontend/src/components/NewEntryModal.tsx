          ...
          <div className="flex min-h-full items-center justify-center p-6">
            ...
            >
              <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <Textarea
                  className=
                  'mt-3 mb-3 block w-full resize-none rounded-lg border-none bg-white py-1.5 px-3 text-sm/6 text-black focus:outline-none data-[focus]:outline-2 data-[focus]:-outline-offset-2 data-[focus]:outline-indigo-500/75'
                  rows={1}
                  {...register("title")}
                />
                ...
                <Textarea
                  className=
                  'mt-3 block w-full resize-none rounded-lg border-none bg-white py-1.5 px-3 text-sm/6 text-black focus:outline-none data-[focus]:outline-2 data-[focus]:-outline-offset-2 data-[focus]:outline-indigo-500/75'
                  rows={11}
                  {...register("content")}
                  />
