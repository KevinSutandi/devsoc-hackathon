...
const STUB_DATE1 = new Date('2024-06-28');
const STUB_DATE2 = new Date('2024-06-27');
const STUB_DATE3 = new Date('2024-06-26');
const STUB_DATE4 = new Date('2024-06-25');
const STUB_DATE5 = new Date('2024-03-10');
const STUB_DATE6 = new Date('2024-01-15');
  ...
  return (
	<div className='p-5'>
		<div className='p-2 w-full rounded-2xl h-full'>	
			...
			<JournalEntry date={STUB_DATE1} text={STUB_TEXT_SHORT}/>
			<JournalEntry date={STUB_DATE2} text={STUB_TEXT_MED}/>
			<JournalEntry date={STUB_DATE3} text={STUB_TEXT_LONG}/>
			<JournalEntry date={STUB_DATE4} text={STUB_TEXT_SHORT}/>
			<JournalEntry date={STUB_DATE5} text={STUB_TEXT_MED}/>
			<JournalEntry date={STUB_DATE6} text={STUB_TEXT_LONG}/>
		</div>
	</div>
  );
};
